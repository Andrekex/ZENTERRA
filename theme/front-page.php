...
<section class="section" id="why">
  <div class="container">
    <div class="section-head">
      ...
      <p class="section-lead">Big agencies are reliable but slow and expensive. Solo freelancers are cheaper but unpredictable. We sit in between: a small team that uses Claude for speed and a team lead who answers for quality.</p>
    </div>
    <div class="table-wrap">
      <table class="compare">
        ...
        <tbody>
          ...
          <tr><th scope="row">Team</th><td>seniors + account manager</td><td>one person</td><td class="hl">team lead + team working with Claude</td></tr>
    ...
    <div class="grid-3">
      ...
      <article class="card service">
        ...
        <ul class="checks">
          ...
          <li>CRM integrations and Claude API integration</li>
  ...
  <div class="container">
    ...
    <div class="price-grid" id="panel-ai" role="tabpanel" aria-labelledby="tab-ai" hidden>
      ...
      <article class="card price">
        ...
        <p class="price-time">2–4 weeks</p>
        <p class="muted">Processing leads and documents, CRM integrations, built on Claude.</p>
      </article>
    </div>
    ...
    <div class="terms">
      ...
      <ul class="terms-list">
        ...
        <li><strong>Your accounts, your assets.</strong> Your Wix plan, hosting and Claude API usage run on your own accounts.</li>
...
<section class="section section-alt" id="process">
  <div class="container">
    ...
    <ol class="steps">
      ...
      <li><span class="step-n">6</span><div><h3>Build</h3><p>Developed with Claude from our tested templates, on a staging site, in 3–10 days.</p></div></li>
...
<section class="section" id="quality">
  <div class="container">
    <div class="section-head">
      ...
      <p class="section-lead">Claude makes our team fast. Our process makes it safe to rely on that speed.</p>
    </div>
    <ol class="cycle">
      <li><span class="who who-human">Human</span><h3>Specification</h3><p>Goal, acceptance criteria and what not to do. No spec, no Claude.</p></li>
      ...
      <li><span class="who who-ai">Claude</span><h3>Implementation</h3><p>Plan first, approved by the lead, then small changes.</p></li>
    ...
    <div class="grid-2 quality-grid">
      ...
      <div class="card">
        ...
        <ul class="checks">
          <li>Client code is handled only in our business Claude Team workspace. Model training on this data is off by default.</li>
          <li>We use Claude under Anthropic's commercial terms: you own the outputs.</li>
  ...
  <div class="container narrow">
    ...
    <div class="faq">
      <details>
        ...
        <p>You pay for the result, not for time. With Claude, work that used to take 40 hours might take 15. Hourly billing would hide that. A fixed price gives you a clear number up front and gives us a reason to stay efficient.</p>
      </details>
      <details>
        <summary>Will AI-written code be good enough?</summary>
        <p>Every change goes through automated checks and is then reviewed by our team lead against the spec and our launch checklist. Claude speeds up the work, and a person is responsible for the quality.</p>
      </details>
      <details>
